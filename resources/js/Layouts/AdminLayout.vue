...
const iconPassword = () => h('svg', { fill: 'none', stroke: 'currentColor', viewBox: '0 0 24 24', 'stroke-width': '1.5', class: 'w-5 h-5' }, [
...
const navItems = [
    ...
    { href: '/admin/password', label: 'Change Password', icon: iconPassword },
];
